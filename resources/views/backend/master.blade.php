...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/asset') }}/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/asset') }}/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet"
        href="{{ asset('backend/asset') }}/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/asset') }}/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
    <!-- Tempusdominus Bootstrap 4 -->
    <link rel="stylesheet"
        href="{{ asset('backend/asset') }}/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- Select2 -->
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/asset') }}/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
    <!-- Bootstrap4 Duallistbox -->
    <link rel="stylesheet"
        href="{{ asset('backend/asset') }}/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
    <!-- BS Stepper -->
    <link rel="stylesheet" href="{{ asset('backend/asset') }}/plugins/bs-stepper/css/bs-stepper.min.css">
    <!-- dropzonejs -->
    <link rel="stylesheet" href="{{ asset('backend/asset') }}/plugins/dropzone/min/dropzone.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('backend/asset') }}/dist/css/adminlte.min.css">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('backend/asset') }}/dist/img/AdminLTELogo.png"
    ...
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="{{ asset('backend/asset') }}/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js">
    </script>
    <!-- Summernote -->
    ...
    <!-- Bootstrap4 Duallistbox -->
    <script src="{{ asset('backend/asset') }}/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>
    <!-- InputMask -->
    <script src="{{ asset('backend/asset') }}/plugins/inputmask/jquery.inputmask.min.js"></script>
    <!-- date-range-picker -->
    <script src="{{ asset('backend/asset') }}/plugins/daterangepicker/daterangepicker.js"></script>
    <!-- bootstrap color picker -->
    ...
    <!-- Bootstrap Switch -->
    <script src="{{ asset('backend/asset') }}/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
    <!-- BS-Stepper -->
    <script src="{{ asset('backend/asset') }}/plugins/bs-stepper/js/bs-stepper.min.js"></script>
    <!-- dropzonejs -->
    <script src="{{ asset('backend/asset') }}/plugins/dropzone/min/dropzone.min.js"></script>
    <!-- AdminLTE App -->
    {{-- <script src="{{ asset('backend/asset') }}/dist/js/adminlte.min.js"></script> --}}
    <!-- AdminLTE for demo purposes -->

    <script src="{{ asset('backend/asset') }}/plugins/bs-custom-file-input/bs-custom-file-input.min.js"></script>
